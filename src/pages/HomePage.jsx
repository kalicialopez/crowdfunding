    ...
    <>
      <body className="page-body">
        ...
        <div className="homepage-intro-text-container">
          <h2>
            The non-for-profit crowdfunding platform that empowers individuals
            to pursue their dreams of education without financial barriers.
          </h2>
          ...
          <p className="page-text">
            ...
            <br />
            <br />
            Similarly, if you understand the impact education can have on the
            life trajectory of an individual, and are in the fortunate position
            to be able to help someone achieve their career aspirations, EducAid
